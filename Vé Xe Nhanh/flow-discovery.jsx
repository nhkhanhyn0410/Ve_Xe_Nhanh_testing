    ...
    <Frame active="buy" signedIn={false}>
      <div style={{ background: "#fff" }}>
        ...
        <HeroLandscape height={620}>
          ...
          >
            ...
            <h1
              style={{
                margin: 0,
                font: "700 56px var(--font-display)",
                color: "#fff",
                lineHeight: 1.05,
            ...
            <p
              style={{
                ...
                maxWidth: 580,
                textShadow: "0 2px 12px rgba(0,40,60,.4)",
              }}
            >
              5,400+ chuyến mỗi ngày · 218 nhà xe đối tác · Tích điểm sau mỗi
              chuyến đi
            </p>
          </div>
        ...
        <section style={{ padding: "24px 56px 48px" }}>
          ...
          >
            {ROUTES_POPULAR.slice(2).map((r) => (
              <RouteCardSmall key={r.from + r.to} route={r} compact />
            ))}
          </div>
        </section>
        ...
        {/* Why Vé Xe Nhanh */}
        <section
          style={{ padding: "32px 56px", background: "var(--vxn-bg-soft)" }}
        >
          <div
            style={{
              display: "grid",
          ...
          >
            {[
              ...
              },
              {
                icon: "phone",
                title: "Hỗ trợ 24/7",
                body: "CSKH tiếng Việt, qua app, Zalo, hotline.",
              },
            ].map((v) => (
          ...
          >
            <div
              style={{
                ...
                overflow: "hidden",
                background:
                  "linear-gradient(110deg, var(--vxn-teal-800) 0%, var(--vxn-teal-700) 60%, #034e63 100%)",
                color: "#fff",
                display: "flex",
                flexDirection: "column",
                justifyContent: "space-between",
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    "radial-gradient(circle, rgba(243,177,50,.3), rgba(243,177,50,0))",
                }}
              />
              <span
                style={{
              ...
              <div>
                ...
                >
                  Tích điểm tự động sau mỗi chuyến đi. Đổi 100 điểm = 100,000đ
                  giảm.
                </p>
                ...
                <div key={t} style={{ display: "flex", gap: 12 }}>
                  <div
                    style={{
                      ...
                      height: 56,
                      borderRadius: 8,
                      background: "linear-gradient(135deg, #FDE7C2, #F9D38A)",
                      flexShrink: 0,
                    }}
                  />
                  <div>
        ...
        >
          <div>
            ...
            >
              Nền tảng đặt vé xe khách toàn quốc. Vận hành bởi Công ty CP VXN,
              Quận 3, TP.HCM.
            </p>
          </div>
          {[
  ...
  return (
    <div
      style={{
        ...
        backdropFilter: "blur(12px)",
        borderRadius: 16,
        boxShadow: "0 30px 60px -20px rgba(0,40,60,.4)",
        padding: 8,
        zIndex: 3,
    ...
    >
      <div
        style={{ display: "flex", borderBottom: "1px solid var(--vxn-border)" }}
      >
        {[
          ["buy", "Mua vé", "ticket"],
          ["lookup", "Tra cứu vé", "qr"],
          ["operators", "Theo nhà xe", "bus"],
        ].map(([k, l, ic], i) => (
          <button
            key={k}
            style={{
      ...
      >
        ...
        >
          <div style={{ display: "flex", gap: 8 }}>
            <Chip tone="saffron" icon="discount">
              MÃ HE2026 · GIẢM 12%
            </Chip>
            <Chip tone="neutral" icon="bag">
              HÀNH LÝ TRẢ TRƯỚC
            </Chip>
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <Chip tone="saffron" style={{ padding: "5px 12px", fontSize: 11 }}>
          NỔI BẬT
        </Chip>
        <Chip
          tone="ink"
      ...
      <div>
        ...
        >
          ...
          <Btn kind="saffron">
            Đặt vé ngay <Icon name="arrowRight" size={14} />
          </Btn>
        </div>
      </div>
    </div>
      ...
      >
        ...
        >
          ...
          {SAMPLE_TRIPS.map((t, i) => (
            <TripCard key={t.id} trip={t} expanded={i === 2} />
          ))}
        </div>
      </div>
    </Frame>
    ...
    >
      <div
        style={{
          flex: 1,
          display: "grid",
          gridTemplateColumns: "1fr 40px 1fr 1fr 1fr",
          border: "1px solid var(--vxn-border)",
          borderRadius: 12,
          overflow: "hidden",
        }}
        ...
        <div style={{ position: "relative", height: 28, margin: "8px 0 12px" }}>
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background: "#fff",
              border: "2px solid var(--vxn-teal-700)",
            }}
          />
          <div
            style={{
      ...
      <FilterGroup title="Nhà xe">
        {OPERATORS.slice(0, 4).map((op) => (
          <CheckRow
            key={op.id}
            label={op.name}
            count={Math.floor(op.fleet / 2)}
            on={op.id === "op1" || op.id === "op3"}
          />
        ))}
        <a
          style={{
...
function CheckRow({ label, count, on }) {
  return (
    ...
    >
      ...
      <span
        style={{ flex: 1, color: on ? "var(--vxn-ink)" : "var(--vxn-fg-2)" }}
      >
        {label}
      </span>
      <span
...
function SortRow() {
  return (
    ...
    >
      ...
      >
        <strong style={{ color: "var(--vxn-teal-700)" }}>142 chuyến</strong> Hà
        Nội → Sapa · T6, 15/05/2026
      </div>
      <div
        style={{
          display: "flex",
...
function TripCard({ trip, expanded }) {
  ...
  return (
    <div
      style={{
        background: "#fff",
        border: `1px solid ${expanded ? accent : "var(--vxn-border)"}`,
        borderRadius: 14,
        overflow: "hidden",
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              ...
              height: 56,
              borderRadius: 12,
              background: trip.operator.color,
              color: "#fff",
              display: "grid",
              placeItems: "center",
        ...
        <div
          style={{
            background: "var(--vxn-bg-soft)",
            borderLeft: "1px solid var(--vxn-border)",
            padding: 20,
            display: "flex",
            flexDirection: "column",
            alignItems: "flex-end",
        ...
        >
          {trip.discount > 0 && (
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <Chip tone="danger" style={{ padding: "2px 8px", fontSize: 10 }}>
                -{trip.discount}%
              </Chip>
            </div>
          )}
        ...
        >
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {[
                ["06:00", "Hà Nội · Văn phòng Trần Duy Hưng"],
                ["08:30", "Lào Cai · Bến xe Trung tâm (nghỉ 20p)"],
                ["11:30", "Sapa · Văn phòng Cầu Mây"],
              ].map(([t, p]) => (
                <div
                  key={t}
                  style={{
          ...
          <div>
            ...
            >
              · Hoàn 100% trước 12h · Hoàn 90% trước 24h
              <br />
              · Đổi chuyến miễn phí trước 24h
              <br />· Trẻ em dưới 1m miễn vé
            </div>
          </div>
        </div>
      )}
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(180deg, rgba(0,40,60,.0) 30%, rgba(0,40,60,.6))",
                }}
              />
              <div
                style={{
              ...
              >
                <div>
                  <Chip tone="saffron" style={{ marginBottom: 10 }}>
                    BÁN CHẠY · CHỈ CÒN 3 CHỖ
                  </Chip>
                  <div
                    style={{
                  ...
                  >
                    Thứ 6, 15 tháng 5, 2026 · {trip.depart} → {trip.arrive}
                  </div>
                </div>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    ({trip.operator.reviews.toLocaleString("vi-VN")} đánh giá)
            ...
            <Card>
              ...
              >
                ...
                {[
                  [
                    "08:15",
                    "Hà Nội · VP Trần Duy Hưng",
                    "14 Trần Duy Hưng, Cầu Giấy",
                    "depart",
                  ],
                  [
                    "09:00",
              ...
              >
                {[
                  [
                    ...
                    "T6, 02/05",
                    5,
                    "Cabin sạch sẽ, tài xế chạy êm, nhân viên gọi điện báo trước 15 phút. Đi cả nhà rất thoải mái.",
                  ],
                  [
                    "Đức Anh",
                    "T2, 28/04",
                    5,
                    "Lần thứ 3 đi cùng Tâm Hạnh, ổn định. Có nước + khăn lạnh + chăn mỏng. Sạc Type-C ở mỗi cabin.",
                  ],
                ].map(([n, d, r, body]) => (
                  <div
                    key={n}
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{ marginLeft: "auto", display: "flex", gap: 1 }}
                      >
          ...
          >
            <Card padding={0} style={{ overflow: "hidden" }}>
              ...
              >
                ...
                >
                  / vé · đã gồm thuế · giảm 7% khi đặt trước
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  ...
                  >
                    3 người khác đang xem chuyến này
                  </span>
                </div>
              </div>
            </Card>
